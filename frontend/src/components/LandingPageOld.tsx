...
export default function LandingPageOld(props: any) {
  return (
    <div
      class={`${props.className} hidden sm:flex flex-col items-center gap-4`}
    >
      <div
        class={`sm:flex flex-col lg:flex-row justify-between pb-4 h-auto w-auto`}
      >
        <div class="flex flex-col gap-4 md:gap-8 ">
          ...
          <div class="text-xl">
            ...
            <GoogleLocation
              className="mt-2 text-md border-2 bg-white text-gray-500 text-sm"
