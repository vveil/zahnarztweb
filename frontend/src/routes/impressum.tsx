  ...
  return (
    ...
    <div class="mtl:mx-0 mx-5 flex flex-col gap-4">
      ...
      <p>
        J&uuml;rgen Werner
        <br />
        Zahnarztpraxis Dr. med. dent. J&uuml;rgen Werner
        <br />
        Weststra&szlig;e 70
        <br />
        381236 Braunschweig
      ...
      <h2>Kontakt</h2>
      <p>
        Telefon: 0531 6802929
        <br />
        Telefax: 05316802930
        <br />
        E-Mail: dr.juergenwerner@arcor.de
      </p>
      ...
      <p>
        ...
        <br />
        Zahn&auml;rztekammer Niedersachsen
        <br />
        Zei&szlig;stra&szlig;e 11a
        <br />
        30519 Hannover
      </p>
      <p>
